...
function deploy_cicd()
{
  ...
  sed -i "s|my-namespace|"$namespace"|g" ~/auto_deployment/automation-scripts/deployment_scripts/multi-app-spec.json
  sed -i "s|my-dockerimage|"$dockerimage"|g" ~/auto_deployment/automation-scripts/deployment_scripts/multi-app-spec.json
  curl --insecure -X POST \
  -H "Authorization: Bearer $argocd_token" \
  -H "Content-Type: application/json" \
  -d @/home/ubuntu/auto_deployment/automation-scripts/deployment_scripts/multi-app-spec.json \
